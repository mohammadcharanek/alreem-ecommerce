            ...
            <div>
                ...
                <div class="relative mt-2">
                    ...
                    <button
                        ...
                        class="absolute inset-y-0 right-0 flex items-center px-4 text-gray-400 transition hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            toggleButtons.forEach(function (toggleButton) {
                ...
                const eyeOpenIcon = toggleButton.querySelector('[data-eye-open]');
                const eyeClosedIcon = toggleButton.querySelector('[data-eye-closed]');
